...
namespace Juno.OnPrem.Auth.Common.Helpers
{
    public static class TokenHelper
    {
        ...
        /// <param name="identity">Windows identity of the user on whose behalf to create the access token</param>
        /// <returns>An access token with an audience of the target principal</returns>
        public static string GetS2SAccessTokenWithADFSIdentity(
            Uri targetApplicationUri,
            string identity)
        {
            string realm = string.IsNullOrEmpty(Realm) ? GetRealmFromTargetUrl(targetApplicationUri) : Realm;

            JsonWebTokenClaim[] claims = identity != null ? GetClaimsWithADFSIdentity(identity) : null;
        ...
        private static ConfigCacheItem config = ConfigHelper.GetCurrentConfigItem();

        private static readonly string ClientId = config.SPClientId;
        private static readonly string IssuerId = config.SPIssuerId;
        private static readonly string HostedAppHostNameOverride = WebConfigurationManager.AppSettings.Get("HostedAppHostNameOverride");
        private static readonly string HostedAppHostName = WebConfigurationManager.AppSettings.Get("HostedAppHostName");
        private static readonly string ClientSecret = string.IsNullOrEmpty(WebConfigurationManager.AppSettings.Get("ClientSecret")) ? WebConfigurationManager.AppSettings.Get("HostedAppSigningKey") : WebConfigurationManager.AppSettings.Get("ClientSecret");
        private static readonly string SecondaryClientSecret = WebConfigurationManager.AppSettings.Get("SecondaryClientSecret");
        private static readonly string Realm = config.SPRealm;
        private static readonly string ServiceNamespace = config.SPRealm;

        private static readonly string ClientSigningCertificatePath = config.CertificatePath;
        private static readonly string ClientSigningCertificatePassword = config.CertificatePassword;
        ...
        private static JsonWebTokenClaim[] GetClaimsWithADFSIdentity(string identity)
        {
            JsonWebTokenClaim[] claims = new JsonWebTokenClaim[]
          {
                new JsonWebTokenClaim("upn", identity),
                 new JsonWebTokenClaim("nii", config.AuthProviderName)
               // new JsonWebTokenClaim("nii", "trusted:LDAPCP")
          };
            return claims;
        }
            ...
            bool appOnly = false)
        {
            ...
            string issuer = issuerApplication;
